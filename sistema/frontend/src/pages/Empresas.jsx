...
export default function Empresas() {
  ...
  return <div className="collection-page">
    <PageHeader eyebrow="CADASTROS" title="Clientes" description="Redes, empresas, investidores, operadores e demais interessados." actions={<Link className="btn btn-gold" to="/empresas/nova" state={{ backgroundLocation: location }}><Plus size={18} weight="bold" /> Novo cliente</Link>} />
